...
export const VideoPlayer: React.FC<Props> = function ({ start, onFinished }) {
    ...
    const renderSeekbar = () => {
        return (
            <View style={styles.seekbar.container} collapsable={false} {...seekPanResponder.current?.panHandlers}>
                <View
                ...
                <View style={[styles.seekbar.handle, { left: seekerPosition }]} pointerEvents={'none'}>
                    <View style={[styles.seekbar.circle, { backgroundColor: '#ffffff' }]} pointerEvents={'none'} />
                </View>
            </View>
        );
    };
    ...
    const renderPlayPause = () => {
        ...
        return renderControl(<Image source={image} />, toggle, styles.controls.playPause);
    };
